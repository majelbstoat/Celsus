...
defined('ZEND_LIBRARY_PATH') || define('ZEND_LIBRARY_PATH', realpath(dirname(__FILE__) . '/../../zend/'));

echo "Zend Library Path is " . ZEND_LIBRARY_PATH . "\n\n";
...
set_include_path(implode(PATH_SEPARATOR, array(ZEND_LIBRARY_PATH, LIBRARY_PATH, TEST_LIBRARY_PATH, get_include_path())));
