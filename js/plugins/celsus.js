 ...
 * 
 * @author xaviershay
 *         http://github.com/xaviershay/jquery-enumerable/blob/master/jquery.enumerable.js
 * @author Jamie Talbot
 */
(function($) {
	var methods = {
...
// Ensure that all requests are sent with the Celsus format header.
$.ajaxSetup({
